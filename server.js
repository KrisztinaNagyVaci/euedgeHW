...
// though the element was required to be removed from the appearing list. Thus I only deleted on frontend until reload. Same
// goes for posting.
// Deletion and posting work without backend, but fetching the data works through the above get method.
